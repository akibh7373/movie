        ...
        <>
            <header className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-5 py-3 bg-transparent text-white">
                ...
                <div className="navArea flex flex-row justify-between items-center">
                    ...
                    <Link href='' className="mr-5 uppercase text-white hover:text-slate-200"><span className="md:hidden block"><FaRegListAlt size={25} /></span><span className="md:block hidden">browse movies</span></Link>
                    <div className="signUpArea flex justify-end items-center">
                        <Link href='' className="md:mr-5 uppercase text-white hover:text-slate-200"><span className="lg:hidden md:hidden sm:block block"> <FaUser size={25} /></span> <span className="lg:block md:block hidden">login</span> </Link>
                    </div>
                </div>
            </header>
        </>
